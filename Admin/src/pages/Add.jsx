...
function Add() {
  ...
  const [subcategory,setSubcategory]=useState("UpperWear");
    ...
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l
     ...
     relative' >
        ...
        justify-start overflow-x-hidden absolute right-0 bottom-[5%]'>
             ...
             <form action='' onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] h-[100%]
             mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] 
             md:px-[60px]'>
              ...
              justify-center flex-col mt-[20px] gap-[10px]'>
                ...
                justify-start'>
                  ...
                  md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#5b46f7]'>
                    <img src={!image1 ?uploadImage:URL.createObjectURL(image1)} alt=''
                    className='w-[80%] h-[80%] rounded-lg shadow-2xl
                    hover:border-[#0f0c10] border-[2px]'/>
                  ...
                  md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#5b46f7]'>
                    <img src={!image2 ?uploadImage:URL.createObjectURL(image2)} alt=''
                    className='w-[80%] h-[80%] rounded-lg shadow-2xl
                    hover:border-[#141315] border-[2px]'/>
                  ...
                  md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#5b46f7]'>
                    <img src={!image3 ?uploadImage:URL.createObjectURL(image3)} alt=''
                    className='w-[80%] h-[80%] rounded-lg shadow-2xl
                    hover:border-[#121113] border-[2px]'/>
                  ...
                  md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#5b46f7]'>
                    <img src={!image4 ?uploadImage:URL.createObjectURL(image4)} alt=''
                    className='w-[80%] h-[80%] rounded-lg shadow-2xl
                    hover:border-[#121013] border-[2px]'/>
              ...
              <div className='w-[80%] h-[220px] md:h-[100px] flex
              items-start justify-center flex-col gap-[10px] py-[10px]
              md:py-[0px]'>
                  <p className='text-[20px] md:text-[25px] font-semibold'>
                    Product Size
                  </p>
                  ...
                  flex-wrap'> 
                      <div className={`px-[20px] py-[7px] rounded-lg
                      bg-slate-600 text-[18px] hover:border-[#46d1f7]
                      border-[2px] cursor-pointer ${sizes.includes('XS') ?
                       "bg-green-400 text-[black] border-[#46d1f7]":""} `}
                       onClick={()=>setSizes(prev=>prev.includes("XS")?
                      ...
                      <div className={`px-[20px] py-[7px] rounded-lg
                      bg-slate-600 text-[18px] hover:border-[#46d1f7]
                      border-[2px] cursor-pointer ${sizes.includes('M') ?
                       "bg-green-400 text-[black] border-[#46d1f7]":""} `}
                      ...
                      <div className={`px-[20px] py-[7px] rounded-lg
                      bg-slate-600 text-[18px] hover:border-[#46d1f7]
                      border-[2px] cursor-pointer ${sizes.includes('L') ?
                       "bg-green-400 text-[black] border-[#46d1f7]":""} `}
                      ...
                      <div className={`px-[20px] py-[7px] rounded-lg
                      bg-slate-600 text-[18px] hover:border-[#46d1f7]
                      border-[2px] cursor-pointer ${sizes.includes('XL') ?
                       "bg-green-400 text-[black] border-[#46d1f7]":""} `}
                      ...
                      <div className={`px-[20px] py-[7px] rounded-lg
                      bg-slate-600 text-[18px] hover:border-[#46d1f7]
                      border-[2px] cursor-pointer ${sizes.includes('XLL') ?
                       "bg-green-400 text-[black] border-[#46d1f7]":""} `}
                       onClick={()=>setSizes(prev=>prev.includes("XLL")?
                       prev.filter(item=>item!=='XLL'):
                       [...prev,'XLL'])}>XLL</div>
                  </div>
              </div>

              <div className='w-[80%] flex items-center justify-start gap-[10px]
              mt-[20px]'>
                <input type='checkbox'id='checkbox' className='w-[25px] h-[25px] 
                cursor-pointer' onChange={()=>setBestseller(prev=>!prev)} />
                <label htmlFor="checkbox" className='text-[18px] 
