...
import about from '../E-commerce MERN Assets/About.png'
...
function About() {
  return (
    <div className=' w-[99vw] min-h-[100vh] flex items-center justify-center flex-col 
     bg-gradient-to-l from-[#190221] to-[#091c45] gap-[50px] pt-[80px]'>
  ...
  TrendWave was born for smart, effortless shopping — created to bring carefully selected products,
  on-trend styles, and everyday essentials together in one convenient place. With dependable service,
  speedy delivery, and great value, TrendWave transforms online shopping into a simple, satisfying,
  and stress-free experience.
</p>

<p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
  We serve modern shoppers who value style, convenience, and affordability. Whether it’s fashion,
  home essentials, or the latest trends, we bring everything you need to one trusted platform —
  backed by fast delivery, easy returns, and customer-first support you can rely on.
</p>

<p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold'>Our Mission</p>

<p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
  Our mission is to redefine online shopping by blending quality, transparency, and convenience.
  TrendWave connects customers with trusted products and brands, delivering a seamless, customer-focused
        ...
        <div className='w-[80%] flex items-center justify-center lg:flex-row flex-col py-[40px]'>
          ...
          <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
            ...
            <p>We guarantee quality through strict checks, reliable sourcing, 
              and a commitment to customer satisfaction always.</p>
          </div>
           <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
           ...
           <div className='lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 
           flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px] text-[white] backdrop-blur-[2px] bg-[#ffffff0b]'>
